    ...
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
      <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        <div className='w-full bg-[#000] lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center '>
          ...
          <span className='text-sm mt-2 text-ascent-2'>Bem vindo de volta</span>
          ...
          >
            ...
            {isSubmitting ? (
              ...
              <CustomButton
                type='submit'
                containerStyles={`inline-flex justify-center rounded-md bg-[#121230] mt-5 px-8 py-3 text-sm font-medium text-white outline-none`}
                title='Entrar'
              />
            )}
          </form>
